...
This document outlines the necessary frontend changes for the updated affiliate system.

## 1. Affiliate Code Changes

### Short Affiliate Codes
- **Change**: Affiliate codes are now 6-8 characters (alphanumeric uppercase) instead of `AFF-XXXXXX` format
