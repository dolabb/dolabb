          ...
          <div className='flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8'>
            ...
            <div className='flex flex-col items-center gap-4'>
              <h3 className='text-deep-charcoal font-semibold text-sm uppercase tracking-wider'>
                {locale === 'en' ? 'Stay Connected' : 'ابق متصلاً'}
              </h3>
              <div className='flex items-center gap-5'>
                ...
                <span className='hidden sm:block w-px h-8 bg-rich-sand/30'></span>
                <Link
                  href={`/${locale}/contact`}
                  className='group relative flex items-center justify-center w-12 h-12 rounded-full bg-white shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-saudi-green hover:to-emerald-500'
                  aria-label='Contact'
                >
                  <HiEnvelope className='w-5 h-5 text-deep-charcoal group-hover:text-white transition-colors duration-300' />
                </Link>
              </div>
            </div>
