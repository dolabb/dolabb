...
export const navigationCategories: NavigationCategory[] = [
  ...
  },
  {
    ...
    href: '/jewellery',
    subCategories: [
      { name: 'Rings', key: 'rings', href: '/jewellery/rings' },
      { name: 'Necklaces', key: 'necklaces', href: '/jewellery/necklaces' },
      { name: 'Earrings', key: 'earrings', href: '/jewellery/earrings' },
      { name: 'Bracelets', key: 'bracelets', href: '/jewellery/bracelets' },
      { name: 'Pendants', key: 'pendants', href: '/jewellery/pendants' },
      { name: 'Chains', key: 'chains', href: '/jewellery/chains' },
      { name: 'Anklets', key: 'anklets', href: '/jewellery/anklets' },
      { name: 'Brooches', key: 'brooches', href: '/jewellery/brooches' },
      { name: 'Cufflinks', key: 'cufflinks', href: '/jewellery/cufflinks' },
    ],
    featured: [
      { name: 'Gold Collection', key: 'gold-collection', href: '/jewellery/gold' },
      { name: 'Silver Collection', key: 'silver-collection', href: '/jewellery/silver' },
      { name: 'Diamond Collection', key: 'diamond-collection', href: '/jewellery/diamond' },
      { name: 'Vintage Jewellery', key: 'vintage-jewellery', href: '/jewellery/vintage' },
      { name: 'See all jewellery', key: 'see-all-jewellery', href: '/jewellery' },
    ],
    styles: [],
  },
  {
